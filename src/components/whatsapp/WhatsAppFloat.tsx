...
const WhatsAppFloat: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 group flex items-center">
      {/* Hover Text */}
      <span className="mr-3 bg-white text-black text-sm px-3 py-1 rounded opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">
        Chat on WhatsApp
      </span>
